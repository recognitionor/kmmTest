...
import com.jhlee.kmmtest.ui.comingsoon.ComingSoonComponent
import com.jhlee.kmmtest.ui.main.MainComponent
import com.jhlee.kmmtest.ui.pokedex.PokedexComponent
...
class RootComponent internal constructor(
    ...
    private fun createChild(configuration: Configuration, componentContext: ComponentContext): Child =
        when (configuration) {
            ...
            is Configuration.Pokedex -> Child.Pokedex(
                pokedex(
                    componentContext,
            ...
            is Configuration.Favorite -> Child.Favorite(
                favorite(
                    componentContext,
                    ::onFavoriteOutput
                )
    ...
    private fun onMainOutput(output: MainComponent.Output): Unit =
        when (output) {
            ...
            is MainComponent.Output.PokedexSearchSubmitted -> navigation.push(
    ...
    private fun onPokedexOutput(output: PokedexComponent.Output): Unit =
        when (output) {
            ...
            is PokedexComponent.Output.NavigateToDetails -> navigation.push(
    ...
    private fun onFavoriteOutput(output: FavoriteComponent.Output): Unit =
        when (output) {
            ...
            is FavoriteComponent.Output.NavigateToDetails -> navigation.push(
                Configuration.Details(
                    output.name
                )
            )
